...
public class SearchController {
	...
	@ResponseBody
	public List<News> searchNews(@RequestParam("searchContent") String searchContent,
			@RequestParam("currentPage") int currentPage, @RequestParam("numPerPage") int numPerPage) {

		System.out.println(
				"searchContent:" + searchContent + ",currentPage:" + currentPage + ",numPerPage:" + numPerPage);
		try {
